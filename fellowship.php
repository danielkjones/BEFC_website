...
<div class="main-div">
    ...
    <div class="container page-content centered info-text">
            ...
            <p> Jesus was very clear: <i>By this all people will know that you are my disciples, if you have love for one another.</i> (John 13:35)</p>

            <p> A basic question:</p>

            <p>How can we ever learn to love each if we don’t know each other?  If we remain perpetual acquaintances!</p>

            <p>We can't!</p>

            <p>So, we aim at friendship.  Which takes time and hard work!</p>
            ...
            <p>Scripture also speaks realistically about the human heart and cautions:</p>
    ...
    <div class="container-fluid gallery">
        <div class="row">
            <div class="col-sm-4">
                <img src="images/DSC_0189.JPG" alt="Gals at the Table" class="gallery-image">
            </div>
            <div class="col-sm-4">
                <img src="images/mELINDA'S GROUP-doorway.jpg" alt="Help at Melinda's'" class="gallery-image">
            </div>
            <div class="col-sm-4">
                <img src="images/wood_stacking.jpeg" alt="Wood Stacking for Friends" class="gallery-image">
            </div>
        </div>
    </div>
